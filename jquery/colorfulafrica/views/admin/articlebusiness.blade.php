...
@section('title', '文章-关于商务合作')
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">商务合作</h3>
        </div>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <?php } ?>
                        <input type="text" name="nameCn" class="form-control" value="<?php if ($article) {echo $article['nameCn'];} else { echo '商务合作';}?>" readOnly="true">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="nameEn" class="form-control" value="<?php if ($article) {echo $article['nameEn'];} else { echo 'businessCooperation';}?>" readOnly="true">
                    </div>
                    <div class="col-sm-6">
                        <p class="small text-muted form-control-static"></p>
                    </div>
