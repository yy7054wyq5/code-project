...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form action="/backstage/commodity/comments/{{$id}}" method="get">
                    ...
                    @if (isset($lists) && count($lists)>0)
                        @foreach($lists as $list)
                            <tr>
                                ...
                                <td>
                                    @if($list['deleted'] == 0)
                                        <a href="/backstage/travel/edit-comment/{{$list['id']}}" class="label label-success" >编辑</a>
                                        <a href="/backstage/travel/remove-comment/{{$list['id']}}" class="label label-danger" m-bind="confirm">删除</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
