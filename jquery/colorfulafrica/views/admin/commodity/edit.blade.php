...
@section('content')
    <div class="box box-primary">
        ...
        <form action="{{url('/backstage/commodity/edit-product')}}" class="form-horizontal" method="post" m-bind="ajax" id="formV" >
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input name="price" type="text" class="form-control" value="{{$detail['price']}}">
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea class="form-control" name="summary">{{$detail['summary']}}</textarea>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea class="form-control" name="summaryEn" >{{$detail['summaryEn']}}</textarea>
                    </div>
                    <div class="col-sm-6">
                        <p class="form-control-static text-muted small">请输入商品摘要</p>
                    </div>
                ...
                @foreach($detail['spec'] as $key=>$spec)
                <div class="form-group spec" data-index="index">
                  <label for="" class="control-label col-sm-2 required"></label>
                    <div class="col-sm-4">
                        <div class="input-group" style="width: 350px;" >
                                <div class="input-group-addon">规格值</div>
                                <input type="text" class="form-control" name="specvalue[{{$spec['id']}}]" value="{{$spec['spec']}}" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div id="album">
                            @if($detail['album'])
                            @foreach($detail['album'] as $value)
                            <div style='float:left;margin-right:5px;'>
                            <image style="width:150px; height:150px;" src="/image/get/{{$value['id']}}" />
                            <a href='javascript:;' onclick="delImg(this,{{$value['id']}})">删除</a>
                            <input type="hidden" id="album" name="album[]" value="{{$value['id']}}" />
                            </div>
                            @endforeach
                            @endif
                        </div>
