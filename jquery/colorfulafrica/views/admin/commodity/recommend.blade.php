...
@section('content')
    <div class="box box-primary">
        ...
        <form action="<?= url('/backstage/commodity/recommend') ?>" class="form-horizontal" method="post" m-bind="ajax">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="username" class="control-label col-sm-2 required">商品缩略图</label>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-6">
                        <p class="form-control-static text-muted small">请上传推荐商品缩略图</p>
                    </div>
                </div>
            </div>
