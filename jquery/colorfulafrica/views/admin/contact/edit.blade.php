...
@section('content')
    <div class="box box-primary">
        ...
        <form action="{{url('/backstage/contact/edit-article')}}" class="form-horizontal" method="post" m-bind="ajax" id="formV" >
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <input type="hidden" name="id" value="{{isset($contacts['id'])?$contacts['id']:''}}">
            <div class="box-body">
                <!-- 错误提示 -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input name="name" id="name" type="text" class="form-control" value="{{isset($contacts['name'])?$contacts['name']:''}}" >
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input name="nameEn" type="text" class="form-control" value="{{isset($contacts['nameEn'])?$contacts['nameEn']:''}}" >
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="describe" type="password" id="container" >{{isset($contacts['describe'])?$contacts['describe']:''}}</textarea>
                    </div>
                </div>
            </div>
