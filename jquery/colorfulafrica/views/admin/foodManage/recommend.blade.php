...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">美食推荐</h3>
        </div>
        <form action="/backstage/food/recommend" class="form-horizontal" method="post" m-bind="ajax">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <p class="form-control-static text-muted small">请上传推荐美食缩略图</p>
                    </div>
                </div>
            </div>
