...
@section('content')
    <div class="box box-primary">
        ...
        <form action="/backstage/adinfo/edit-info" class="form-horizontal" method="post" m-bind="ajax">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input name="name" type="text" class="form-control" value="{{$lists['name']}}" />
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input name="nameEn" type="text" class="form-control" value="{{$lists['nameEn']}}" />
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input name="summary" type="text" class="form-control" value="{{$lists['summary']}}">
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-2">
                        <select name="countryId" id="" class="form-control">
                            ...
                            @foreach(\App\Http\Controllers\Admin\BaseController::getCountry() as $country)
                                <option value="{{$country['id']}}" @if($lists['countryId']==$country['id']) selected @endif>{{$country['name']}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" id="picKey" name="picKey" value="{{$lists['picKey']}}" />
                        <div class="col-sm-7 col-md-7" id="image">
                            <a href="#" class="thumbnail" ><image style="width:150px; height:150px;" src="/image/get/{{$lists['picKey']}}" /></a>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea name="detail" type="password" id="container" >{{$lists['detail']}}</textarea>
                    </div>
                </div>
            </div>
