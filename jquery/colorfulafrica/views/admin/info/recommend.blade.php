...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">推荐资讯</h3>
        </div>
        <form action="/backstage/adinfo/recommend-info" class="form-horizontal" method="post" m-bind="ajax">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="hidden" id="picKey" name="picKey" value="{{isset($detail['picKey'])?$detail['picKey']:''}}" />
                        <div id="image">
                    ...
                    <div class="col-sm-6">
                        <p class="form-control-static text-muted small">请上传推荐资讯缩略图</p>
                    </div>
                </div>
            </div>
            <div class="form-group">
                    <label for="username" class="control-label col-sm-2 required">资讯位置</label>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-6">
                        <p class="form-control-static text-muted small">请选择主页资讯位置,不选则为资讯列表</p>
                    </div>
                </div>
