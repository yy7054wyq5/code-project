...
@section('content')
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">编辑线路</h3>
        </div>
        <form action="{{url('/backstage/line/edit-line')}}" class="form-horizontal" method="post" m-bind="ajax" id="formV" >
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane fade in active" id="base">
                                ...
                                <select name="base[categoryId]" class="form-control" >
                                    ...
                                    @if(count($categories)>0)
                                        @foreach($categories as $key => $value)
                                            <option value="{{$key}}" @if($key==$detail['categoryId']) selected @endif >{{$value}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="base[name]" type="text" class="form-control" value="{{$detail['name']}}" >
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="base[nameEn]" type="text" class="form-control" value="{{$detail['nameEn']}}" >
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-2">
                                <select name="base[countryId]" id="" class="form-control">
                                    ...
                                    @foreach(\App\Http\Controllers\Admin\BaseController::getCountry() as $country)
                                        <option value="{{$country['id']}}" @if($country['id']==$detail['countryId']) selected @endif>{{$country['name']}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input name="base[feeStart]" type="text" class="form-control" placeholder="起始费用" value="{{$detail['feeStart']}}" >
                            </div>
                            <div class="col-sm-2">
                                <input name="base[feeEnd]" type="text" class="form-control" placeholder="截止费用" value="{{$detail['feeEnd']}}" >
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="hidden" id="picKey" name="base[picKey]" value="{{$detail['picKey']}}" />
                                <div class="col-sm-7 col-md-7" id="image"  >
                                    <a href="#" class="thumbnail" ><image style="width:150px; height:150px;" src="/image/get/{{$detail['picKey']}}" /></a>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" name="base[summary]" >{{$detail['summary']}}</textarea>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" name="base[notice]">{{$detail['notice']}}</textarea>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" name="base[visa]" >{{$detail['visa']}}</textarea>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="container"  name="base[detail]" >{{$detail['detail']}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="commenity">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 selectedItemCommenity" >
                                @foreach($detail['foods'] as $item)
                                    <span class="cellitem" onclick="del(this)" commodity-id="{{$item['info']['id']}}" ><input type="hidden" name="foods[]" value="{{$item['info']['id']}}" />{{$item['info']['name']}}<i class="fa fa-check"></i></span>
                                @endforeach
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 selectedItemStrategy" >
                                  @foreach($detail['travels'] as $item)
                                    <span class="cellitemStrategy" onclick="del(this)" travel-id="{{$item['info']['id']}}" ><input type="hidden" name="travels[]" value="{{$item['info']['id']}}" />{{$item['info']['name']}}<i class="fa fa-check"></i></span>
                                @endforeach
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                type: "GET",
                url:"/backstage/line/foods/{{$detail['id']}}",
