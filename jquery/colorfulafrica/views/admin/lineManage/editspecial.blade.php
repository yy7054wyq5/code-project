...
@section('content')
    <div class="box box-primary">
        ...
        <form action="{{url('/backstage/line/edit-special')}}" class="form-horizontal" method="post" m-bind="ajax" id="formV" >
            <input type="hidden" name="_token" value="{{csrf_token()}}">
            <input type="hidden" name="id" value="{{$special['id']}}">
            <input type="hidden" name="qid" value="{{$special['qid']}}">
            <div class="box-body">
                <!-- 错误提示 -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea class="form-control" name="title" >{{$special['title']}}</textarea>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="isspec">
                    ...
                    @foreach($special['option'] as $option)
