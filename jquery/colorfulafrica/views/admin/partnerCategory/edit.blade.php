...
@section('title', '编辑合作伙伴分类')
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">编辑合作伙伴分类</h3>
        </div>
        <form action="<?=url('/backstage/partner/edit-category')?>" class="form-horizontal" method="post" m-bind="ajax" id="formV" >
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div id="image"><image style="width:150px; height:150px;" src="/image/get/{{$list['picKey']}}" />'</div>
                    </div>
                    <div class="col-sm-6">
