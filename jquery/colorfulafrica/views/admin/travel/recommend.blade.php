...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">游记资讯</h3>
        </div>
        <form action="<?= url('/backstage/travel/recommend') ?>" class="form-horizontal" method="post" m-bind="ajax">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="username" class="control-label col-sm-2 required">游记缩略图</label>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-6">
                        <p class="form-control-static text-muted small">请上传推荐游记缩略图</p>
                    </div>
                </div>
            </div>
