...
<div class="box border primary">
    <div class="box-title">
        <h4><i class="fa fa-bars"></i>活动编辑</h4>
    ...
    <div class="box-body big">
        <form class="form-horizontal" id="form" onsubmit="return false;">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[name]" value="{{ $info->name }}" class="form-control" placeholder="请输入标题">
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4" id="cover">
                    <img src="{{ $cover }}" style="width: 100px;height: 100px;" id="newImage" class="img"><input type="hidden" class="imagevalue" id="Image" name="info[back]" value="{{ $info->back }}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4" id="cover">
                    <div>
                        <input type="text" name="info[top][]" value="{{ $top ? $top[0] : '' }}" placeholder="请输入第一个链接" class="form-control" /><br/>
                    </div>
                    <div>
                        <input type="text" name="info[top][]" value="{{ $top ? $top[1] : '' }}" placeholder="请输入第二个链接" class="form-control" /><br/>
                    </div>
                    <div>
                        <input type="text" name="info[top][]" value="{{ $top ? $top[2] : '' }}" placeholder="请输入第三个链接" class="form-control" /><br/>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4" id="option">
                    ...
                    <div>
                        <input type="text" name="info[option][]" value="{{ $value->name }}" placeholder="请输入分类" class="form-control" /><br/>
                    </div>
                    @endforeach
                    @endif
                </div>
...
function update()
{
    $.ajax({
        type: "POST",
        url:"/superman/activity/updateact",
        data:$('#form').serialize(),
        dataType: 'json',
