                ...
                <div class="box-body">
                    <form class="form-horizontal" id="form" onsubmit="return false;" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea name="brandDesc"  rows="3"  class="form-control"   ></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">类型</label>
                            <div class="col-sm-4">
                                <input type="radio" name="type" checked="checked"  value="1" /> 普通
                                <input type="radio" name="type"   value="0"  /> 热门
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="radio" name="status"  checked="checked"  value="0"  /> 上架
                            </div>
                        </div>
                        <div class="form-group">
