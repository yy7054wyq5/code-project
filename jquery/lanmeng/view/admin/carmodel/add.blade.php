    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box border primary">
                <div class="box-title">
                    <h4><i class="fa fa-table"></i>添加车型</h4>
                ...
                <div class="box-body">
                    <form class="form-horizontal" id="form" onsubmit="return false;" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="ucfirst"  class="form-control"   />
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="radio" name="status"  checked="true"  value="0"  /> 上架
                            </div>
                        </div>
                        <div class="form-group">
