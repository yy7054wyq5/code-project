    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box border primary">
                <div class="box-title">
                    <h4><i class="fa fa-table"></i>修改车型</h4>
                ...
                <div class="box-body">
                    <form class="form-horizontal" id="form" onsubmit="return false;" >
                        ...
                        <input type="hidden" name="carmodelId"  value="{{ $lists->carmodelId }}">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">所属品牌</label>
                            <div class="col-sm-4">
                                <select name="brandId" class="form-control"  >
                                    @foreach($brandList as $item)
                                        <option value="{{$item->brandId}}" {!! ($item->brandId == $lists->brandId)?"selected":""   !!}  >{{$item->brandName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="carmodelName" value="{{$lists->carmodelName}}"  class="form-control"   />
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">车型首字母</label>
                            <div class="col-sm-4">
                                <input type="text" name="ucfirst"  value="{{$lists->ucfirst}}"  class="form-control"   />
                            </div>
                            <div class="col-sm-4">
                                <p class="text-muted small form-control-static"><font color="red">注：为空自动获取品牌名称首字母</font></p>
                            </div>
                        </div>
                        <div class="form-group">
