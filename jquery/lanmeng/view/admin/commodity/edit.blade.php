            ...
            <div class="box border primary">
                ...
                <div class="box-body">
                    <form class="form-horizontal" id="form" onsubmit="return false;" >
                        ...
                        <input type="hidden" name="commodityId"  value="{{ $lists->commodityId }}">
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane fade in active" id="home">
                                    ...
                                    <div class="col-sm-4">
                                        <select id="commoditycategory" class="form-control" >
                                            ...
                                            @foreach($commodityCategoryList as $item)
                                                @if($lists->categoryId == $item->categoryId)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="commodityName" value="{{$lists->commodityName}}"  class="form-control"   />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">商品副标题</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="commodityTitle" value="{{$lists->commodityTitle}}"  class="form-control"   />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">商品编号</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="productId" value="{{$lists->productId}}"  class="form-control"   />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">起订量</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="number" value="{{$lists->number}}"  class="form-control"   />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">商品说明</label>
                                    <div class="col-sm-4">
                                        <textarea name="describe"  class="form-control" >{{$lists->describe}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="radio" name="status" selected = "selected"  value="0"  /> 上架
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">推荐</label>
                                    <div class="col-sm-4">
                                        <input type="checkbox" name="recommend"  {!! $lists->recommend == 1 ? "selected":"" !!} value="1" /> 复选多多推荐
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="ios">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="oldPrice" value="{{$lists->oldPrice}}"  class="form-control"   />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">促销价</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="promotionPrice" value="{{$lists->promotionPrice}}"  class="form-control"   />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">最多可使用积分</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="integral" value="{{$lists->integral}}"  class="form-control"   />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">内容</label>
                                    <div class="col-sm-4">
                                        <textarea name="content" class="form-control" value="{{$lists->content}}" ></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"></label>
