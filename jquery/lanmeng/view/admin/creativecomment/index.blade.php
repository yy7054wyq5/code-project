...
@section('content')
    ...
    <div class="box border primary">
        <div class="box-title">
            <h4><i class="fa fa-table"></i>创意设计评论管理</h4>
            ...
            <div id="datatable1_wrapper" class="dataTables_wrapper form-inline" role="grid">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="clearfix">
                        &nbsp;&nbsp;
                        <button class="btn btn-sm btn-info" onclick="exports('/superman/creativecomment/excomment')">导出Excel</button>
                        </div>
                    </div>
                </div>
                <form class="form-horizontal" onsubmit="return false;" id="form">
                    ...
                    <table id="datatable1" style="TABLE-LAYOUT: fixed" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover dataTable" aria-describedby="datatable1_info">
                        ...
                        <tr role="row">
                            ...
                            <th width="40%"  style="WORD-WRAP: break-word"  >评论内容</th>
                            <th width="10%">审核</th>
                        </tr>
                        </thead>
...
<script type="text/javascript" >
    $(function(){
        ...
        $("select[name='top']").change(function(){
            ...
            $.ajax({
                type: "POST",
                url:"/superman/creativecomment/modifystatus",
    ...
    function store()
    {
        $.ajax({
            type: "POST",
            url:"/superman/creativecomment/del",
            data:$('#form').serialize(),
            dataType: 'json',
            success: function(msg) {
                layer.msg(msg['tips'])
    ...
    function reload()
    {
        location.href = '/superman/creativecomment/index';
    }
</script>
@stop