        ...
        <form class="form-horizontal" id="form" onsubmit="return false;">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" name="info[name]" placeholder="请输入活动名称" class="form-control" />
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="form-control" name="info[type]">
                        <option value="4">按件数计算(单位：件)</option>
                        <option value="5">按重量计算(单位：Kg)</option>
                        <option value="6">按体积计算(单位：立方)</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[startnum]" placeholder="起计量" class="form-control" />
                </div>
                <div class="col-sm-4">
                    <p class="text-muted small form-control-static"><font color="red">*必填</font></p>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[accnum]" placeholder="累加量"  class="form-control" />
                </div>
                <div class="col-sm-4">
                    <p class="text-muted small form-control-static"><font color="red">*必填</font></p>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[startprice]" placeholder="起计量价格" class="form-control" />
                </div>
                <div class="col-sm-4">
                    <p class="text-muted small form-control-static"><font color="red">*必填</font></p>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[accprice]" placeholder="累加量价格"  class="form-control" />
                </div>
                <div class="col-sm-4">
                    <p class="text-muted small form-control-static"><font color="red">*必填</font></p>
                </div>
                ...
                <div class="col-sm-9">
                    <table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover dataTable" aria-describedby="datatable1_info">
                        ...
                        <tr>
                            ...
                            <input type="checkbox" class="checkall" name="city[]" value="{{ $value['parentid'] }}">
                            </td>
                        @if (isset($value['sub']))
                        <td class="sub-check">
                        @foreach ($value['sub'] as $v)
                            &nbsp;&nbsp;&nbsp;<input type="checkbox" name="city[]" value="{{ $v['subid'] }}">{{ $v['subname'] }}
                        @endforeach
                        </td>
                        </tr>
                        @endif
