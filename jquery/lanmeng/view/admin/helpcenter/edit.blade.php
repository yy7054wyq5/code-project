    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box border primary">
                <div class="box-title">
                    <h4><i class="fa fa-table"></i>修改帮助文章</h4>
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="hidden" name="articleId" value="{{$lists->articleId}}" >
                                <select id="select-type"  class="form-control" >
                                    @foreach($typeList as $item)
                                        @if($lists->typeId == $item->typeId)
                                ...
                                <input type="hidden" name="typeName"    class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">文章标题</label>
                            <div class="col-sm-4">
                                <input type="text" name="articleTitle"  placeholder="请输入文章标题" value="{{$lists->articleTitle}}"  class="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">显示顺序</label>
                            <div class="col-sm-4">
                                <input type="text" name="sort"  placeholder="请输入显示顺序" value="{{$lists->sort}}"  class="form-control" />
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea type="text" id="container"  name="articleContent"   style="width: 800px; height: 500px;  ">{{$lists->articleContent}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
