    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box border primary">
                <div class="box-title">
                    <h4><i class="fa fa-table"></i>修改资讯广告位</h4>
                    ...
                    <form class="form-horizontal" id="form" onsubmit="return false;" >
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                {!! Form::select('',$position,$lists->position,['id'=>'operation','class'=>'form-control']) !!}
...
//               displayObj.after("<input type='hidden' name='image' value='"+respone.url+"'/>");
    ...
    function store()
    {
        $.ajax({
            type: "POST",
            url:"/superman/infoadvertisement/edit",
            data:$('#form').serialize(),
            dataType: 'json',
    ...
    function reload()
    {
        location.href = '/superman/infoadvertisement/index';
    }
</script>