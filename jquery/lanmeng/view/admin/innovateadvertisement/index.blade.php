...
@section('content')
    ...
    <div class="box border primary">
        <div class="box-title">
            <h4><i class="fa fa-table"></i>创库广告位管理</h4>
        ...
        <div class="box-body">
            <div id="datatable1_wrapper" class="dataTables_wrapper form-inline" role="grid">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="pull-left">
                            <form action="/superman/innovateadvertisement/index" method="get">
                        ...
                        <div class="clearfix">
                            @if(in_array('add', $buttonrole))&nbsp;&nbsp; <a href="/superman/innovateadvertisement/add" class="btn btn-sm btn-primary">新增</a>@endif
                        </div>
                    </div>
                </div>
                    ...
                    @if (count($lists)>0)
                        @foreach ($lists as $value)
                            <tr>
                                ...
                                <td style="WORD-WRAP: break-word"  >@if(in_array('edit', $buttonrole))<a href="/superman/innovateadvertisement/edit/{{$value->advId}}" class="btn btn-success btn-xs" >修改</a>@endif
                                    @if(in_array('del', $buttonrole))<a href="/superman/innovateadvertisement/delone/{{$value->advId}}" class="btn btn-danger btn-xs" >删除</a>@endif
                                </td>
                            </tr>
                        @endforeach
                    @else
