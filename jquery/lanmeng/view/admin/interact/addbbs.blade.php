...
<div class="box border primary">
    <div class="box-title">
        <h4><i class="fa fa-bars"></i>互动社区帖子添加</h4>
        ...
        <form class="form-horizontal" id="form" onsubmit="return false;">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" name="bbs[title]" placeholder="请输入帖子标题" class="form-control" />
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="bbs[url]" placeholder="请输入帖子链接" class="form-control" />
                </div>
            </div>
            <div class="form-group">
