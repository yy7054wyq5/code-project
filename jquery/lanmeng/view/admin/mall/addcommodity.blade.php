    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box border primary">
                <div class="box-title">
                    <h4><i class="fa fa-table"></i>新增商品信息</h4>
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane fade in active" id="home">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="info[minNumber]"  class="form-control" value="1"/>
                                    </div>
                                    <div class="col-sm-4">
                                        <p class="text-muted small form-control-static"><font color="red">*必填</font></p>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="info[sort]"  class="form-control" value="0"/>
                                    </div>
                                </div>
                                <div class="form-group">
...
//               displayObj.after("<input type='hidden' name='image' value='"+respone.url+"'/>");
        ...
        // 运费计算方式选择
        var payMethod = $('input[name="shippingMethod"]').val();
        if(payMethod == 5){
    ...
    function store()
    {
        ...
        $.ajax({
            type: "POST",
            url:"/superman/mall/addcommodity",
            data:$('#form').serialize(),
            dataType: 'json',
            success: function(msg) {
                layer.msg(msg['tips'])
