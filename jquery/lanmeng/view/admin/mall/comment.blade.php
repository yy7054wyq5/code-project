    ...
    <div class="box border primary">
        ...
        <div class="box-body">
            <div id="datatable1_wrapper" class="dataTables_wrapper form-inline" role="grid">
                <div class="row">
                    <div class="clearfix">
                    &nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-sm btn-info" onclick="exports('/superman/mall/excomment')">导出Excel</button>
                    </div>
                </div>
            </div>
                ...
                <table id="datatable1" style="TABLE-LAYOUT: fixed"  cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover dataTable" aria-describedby="datatable1_info">
                    ...
                    @if (count($comments)>0)
                        @foreach ($comments as $comment)
                            <tr>
                                <td style="WORD-WRAP: break-word"  align="center"><input type="checkbox" name="id[]" class="J_checkitem" value="{{ $comment['id'] }}"></td>
...
<script type="text/javascript" >
    ...
    function reload()
    {
        location.href = '/superman/mall/comment';
    }
</script>