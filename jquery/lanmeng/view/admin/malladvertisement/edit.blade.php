    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box border primary">
                <div class="box-title">
                    <h4><i class="fa fa-table"></i>修改商城广告位</h4>
                    ...
                    <form class="form-horizontal" id="form" onsubmit="return false;" >
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="hidden" name="advId" id="token" value="{{ $lists->advId}}">
                                {!! Form::select('position',$position,$lists->position,['id'=>'operation','class'=>'form-control']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                {!!Form::text('title',$lists->title,['class'=>'form-control','placeholder'=>'请输入信息标题'])!!}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">链接</label>
                            <div class="col-sm-4">
                                {!!Form::text('link',$lists->link,['class'=>'form-control','placeholder'=>'请输入链接',])!!}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">广告原价</label>
                            <div class="col-sm-4">
                                {!!Form::text('originalPrice',$lists->originalPrice,['class'=>'form-control','placeholder'=>'请输入价格',])!!}
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">广告现价</label>
                            <div class="col-sm-4">
                                {!!Form::text('presentPrice',$lists->presentPrice,['class'=>'form-control','placeholder'=>'请输入价格',])!!}
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                {!!  Form::textarea('description',$lists->description,[ 'rows'=>3 ,'class'=>'form-control'])!!}
                            </div>
                        </div>
                        <div class="form-group">
...
//               displayObj.after("<input type='hidden' name='image' value='"+respone.url+"'/>");
    ...
    function store()
    {
        $.ajax({
            type: "POST",
            url:"/superman/malladvertisement/edit",
            data:$('#form').serialize(),
            dataType: 'json',
    ...
    function reload()
    {
        location.href = '/superman/malladvertisement/index';
    }
</script>