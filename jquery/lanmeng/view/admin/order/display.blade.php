...
<div class="box border primary">
    <div class="box-title">
        <h4><i class="fa fa-table"></i>展厅家具订单</h4>
    ...
    <div class="box-body">
        <div id="datatable1_wrapper" class="dataTables_wrapper form-inline" role="grid">
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-left">
                        <form action="/superman/order/display" method="get">
                    ...
                    @endif
                    &nbsp;&nbsp;
                    <button class="btn btn-sm btn-info" onclick="showDate('/superman/order/exportexcel/1')">导出Excel</button>
