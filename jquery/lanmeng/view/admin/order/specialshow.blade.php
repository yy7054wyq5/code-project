    ...
    <div class="box-body big">
        <form class="form-horizontal" id="form" onsubmit="return false;">
                    ...
                    <table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover dataTable" aria-describedby="datatable1_info">
                        <tbody>
                            <tr data-id="1">    
                                ...
                                @else
                                <td>{{ sprintf("%.2f", ($baseinfo->price + $baseinfo->freight + $baseinfo->install)) }}</td>
                                @endif
                            </tr>
                            <tr data-id="1">    
                            ...
                            <tr data-id="1">
                                <td>运费</td>
                                <td>{{ $baseinfo->freight }}</td>
                            </tr>
                            <tr data-id="1">
                                <td>安装费</td>
                                <td>{{ $baseinfo->install }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" readonly value="{{ $baseinfo->logistics }}" class="form-control"   >
                </div>
            </div>
            <div class="form-group">
