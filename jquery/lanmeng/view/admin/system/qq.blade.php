...
<div class="box border primary">
    <div class="box-title">
        <h4><i class="fa fa-table"></i>QQ客服</h4>
    ...
    <div class="box-body">
        <div id="datatable1_wrapper" class="dataTables_wrapper form-inline" role="grid">
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-left">
                        <form action="/superman/system/qq" method="get">
                    ...
                    <a href="/superman/system/qqcreate" class="btn btn-sm btn-info">新增</a>
                    @endif
                    &nbsp;&nbsp;
            ...
            <table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover dataTable" aria-describedby="datatable1_info">
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr>
                        ...
                        <td>{{ $value->user }}</td>
                        <td>{{ $value->updated }}</td>
                        <td>@if(in_array('edit', $buttonrole))<a class="btn btn-success btn-xs" href="/superman/system/edit/{{ $value->id }}">修改</a>@else --- @endif</td>
                    </tr>
                    @endforeach
                    @else
                    <tr>
...
function delCheckItems() {
    ...
    layer.confirm('您确定要删除选中的内容么？', {
        ...
        $.post("/superman/system/dellist", { group: temp,  _token : $("#token").val() } );
