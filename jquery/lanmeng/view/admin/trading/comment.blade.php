    ...
    <div class="box-body">
        <div id="datatable1_wrapper" class="dataTables_wrapper form-inline" role="grid">
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-left">
                        <form action="/superman/trading/comment" method="get">
                    ...
                    @endif
                    &nbsp;&nbsp;
                    <button class="btn btn-sm btn-info" onclick="exports('/superman/trading/excomment')">导出Excel</button>
            ...
            <table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover dataTable" aria-describedby="datatable1_info">
                ...
                <tbody role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr>
                        ...
                        <td>@if(in_array('edit', $buttonrole))<a href="/superman/trading/top/{{ $value->id }}?status=1" class="btn btn-primary btn-xs">置顶</a>&nbsp;<a href="/superman/trading/top/{{ $value->id }}?status=0" class="btn btn-danger btn-xs">取消</a>@else --- @endif</td>
                        <td>@if(in_array('edit', $buttonrole))<a href="/superman/trading/status/{{ $value->id }}?status=2" class="btn btn-success btn-xs">通过</a>&nbsp;<a class="btn btn-danger btn-xs" href="/superman/trading/status/{{ $value->id }}?status=1">驳回</a>@else --- @endif</td>
                    </tr>
                    @endforeach
                    @else
                    <tr>
