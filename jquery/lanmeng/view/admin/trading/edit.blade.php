...
<div class="box border primary">
    <div class="box-title">
        <h4><i class="fa fa-bars"></i>编辑供求信息</h4>
    ...
    <div class="box-body big">
        <form class="form-horizontal" id="form" onsubmit="return false;">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[title]" class="form-control" value="{{ $info->title }}" placeholder="请输入标题">
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="form-control" id="brand" onchange="getCar();" name="info[brand]">
                        ...
                        <option @if($info->brand == $value->brandId) selected @endif value="{{ $value->brandId }}" data-id="{{ $value->brandId }}">{{ $value->brandName }}</option>
                        @endforeach
                        @endif
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class='hero-multiselect'>
                        ...
                        @if(isset($info->cartype[0]))
                        @foreach($info->cartype as $value)
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" value="{{ date('Y-m-d H:i:s', $info->factorytime) }}" name="info[factorytime]" placeholder="出厂日期" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" class="form-control" />
                </div>
                <div class="col-sm-4">
                    <p class="text-muted small form-control-static"><font color="red">*必填</font></p>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="form-control" onchange="getCity();" id="province" name="info[province]">
                        ...
                        <option @if($info->province == $value->id ) selected @endif value="{{ $value->id }}" data-id="{{ $value->id }}">{{ $value->name }}</option>
                        @endforeach
                        @endif
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="form-control" id="city" name="info[city]">
                        ...
                        <option @if($info->city == $value->id ) selected @endif value="{{ $value->id }}" data-id="{{ $value->id }}">{{ $value->name }}</option>
                        @endforeach
                        @endif
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[address]" value="{{ $info->address }}" placeholder="请填写详细地址" class="form-control">
                </div>
                <div class="col-sm-4">
                    <p class="text-muted small form-control-static"><font color="red">*必选(必填)</font></p>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[linkname]" value="{{ $info->linkname }}" placeholder="请填写联系人" class="form-control">
                </div>
                <!-- <div class="col-sm-4">
                    <p class="text-muted small form-control-static"><font color="red">*必选(必填)</font></p>
                </div> -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[mobile]" value="{{ $info->mobile }}" class="form-control" placeholder="请输入手机号码">
                </div>
                <div class="col-sm-4">
                    <p class="text-muted small form-control-static"><font color="red">*必填</font></p>
                </div>
            ...
            <!-- <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[phone]" value="{{ $info->phone }}" class="form-control" placeholder="请输入固话号码">
                </div>
            </div> -->
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[price]" onKeyUp="javascript:checkInput(this);" onMouseDown="javascript:checkInput(this);" value="{{ $info->price }}" class="form-control" placeholder="请输入单价">
                </div>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="info[num]" onKeyUp="javascript:checkInput(this);" onMouseDown="javascript:checkInput(this);" value="{{ $info->num }}" class="form-control" placeholder="请输入数量">
                </div>
                <div class="col-sm-4">
                    <p class="text-muted small form-control-static"><font color="red">*必填(仅限数字)</font></p>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="form-control" name="info[quality]">
                        <option value="1" @if($info->quality == 1) selected @endif>一成新</option>
                        <option value="2" @if($info->quality == 2) selected @endif>两成新</option>
                        <option value="3" @if($info->quality == 3) selected @endif>三成新</option>
                        <option value="4" @if($info->quality == 4) selected @endif>四成新</option>
                        <option value="5" @if($info->quality == 5) selected @endif>五成新</option>
                        <option value="6" @if($info->quality == 6) selected @endif>六成新</option>
                        <option value="7" @if($info->quality == 7) selected @endif>七成新</option>
                        <option value="8" @if($info->quality == 8) selected @endif>八成新</option>
                        <option value="9" @if($info->quality == 9) selected @endif>九成新</option>
                        <option value="10" @if($info->quality == 10) selected @endif>全新</option>
                    </select>
                </div>
                <div class="col-sm-4">
                    <p class="text-muted small form-control-static"><font color="red">*必选</font></p>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <textarea id="container" name="info[content]" style="width:600px;height:500px;">{{ $info->content }}</textarea>
                </div>
            </div>
            <div class="form-group">
