<div class="box-body big">
    ...
    <form class="form-horizontal" role="form" onsubmit="return false;">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" name="user[netcode]" value="{{ $info->netcode }}" class="form-control" placeholder="请输入公司网络代码">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">展厅面积(㎡)</label>
            <div class="col-sm-4">
                <input type="text" name="user[rank]" value="{{ $info->rank }}" class="form-control" placeholder="请输入展厅面积(㎡)">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" name="user[weibo]" value="{{ $info->weibo }}" class="form-control" placeholder="请输入官方微博客">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">微信公众号</label>
            <div class="col-sm-4">
                <input type="text" name="user[weixin]" value="{{ $info->weixin }}" class="form-control" placeholder="请输入微信公众号">
            </div>
        </div>
        <div class="form-group">
