...
<div class="container business-main">
    ...
    <tbody>
        <tr>
          <td>素材名称</td>
          <td colspan="4"><div class="input-box title"><input type="text" name="materialName" maxlength="30" id="materialName"><span class="now-w">0</span>/30</div></td>
        </tr>
        <tr>
          <td>品牌</td>
        ...
        <ul class="lem-drop lem-drop-input">
          <li class="dropdown Zindex99">
              ...
              <input type="hidden" id="subsortID">
              {{-- 获取二级分类ID --}}
        </ul></div></td>
        </tr>
        <tr>
            <td>积分</td>
            <td colspan="4"><div class="input-box point"><input type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'') " onafterpaste="this.value=this.value.replace(/[^\d]/g,'') " id="point"><span>0</span>/100</div></td>
        </tr>
        <tr>
    ...
    <p class="ms">详细描述</p>
    {!!HTML::script('common/ueconfig.js') !!}<textarea name="describle" id="editTxt"></textarea>
